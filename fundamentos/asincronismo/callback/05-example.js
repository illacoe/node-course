// Implementación de una API con XMLHttpRquest y callback

//XMLHttpRequest es la forma antigua de hacer llamados.
//Permite hacer peticiones a algun servidor en la nube, se instala en package.json
...
function fetchData(url_api, callback){
    ...
    donde: parametro1 = el metodo(en este caso GET, de peticion), parametro2 = la url,
